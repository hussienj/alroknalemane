            ...
            >
                ...
                <div className="text-center">
                    ...
                    <div className="flex flex-col md:flex-row justify-center items-center gap-8 md:gap-12 my-8">
                        ...
                        {/* Ahmed Jawad Kazim Al-Zirfi */}
                        <div className="flex flex-col items-center">
                             <div className="relative p-1 rounded-full bg-gradient-to-tr from-purple-400 to-indigo-500 shadow-lg">
                                <img 
                                    src="https://i.imgur.com/zv9TRgZ.png" 
                                    alt="اشراف الأستاذ احمد جواد كاظم الزرفي" 
                                    className="w-32 h-32 md:w-36 md:h-36 rounded-full object-contain border-4 border-white bg-white p-1"
                                />
                            </div>
                            <h3 className="mt-4 text-lg font-semibold text-gray-600">اشراف الأستاذ</h3>
                            <p className="text-xl font-bold text-purple-600">احمد جواد كاظم الزرفي</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-inner border text-gray-700 text-lg leading-relaxed space-y-4">
                        ...
                        <p className="border-t pt-4 mt-4 border-gray-200">
                            💡 تم تطوير المنصة على يد الأستاذ <strong className="text-cyan-700">حسين جهاد رضا</strong>، وبإشراف مباشر ودعم كريم من مدير مدرسة الركن اليماني الأستاذ <strong className="text-purple-700">احمد جواد كاظم الزرفي</strong>، لنصنع معًا نقلة نوعية في الإدارة المدرسية نحو مستقبل أكثر تميزًا ورقيًا.
                        </p>
                    </div>
